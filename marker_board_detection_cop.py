...
markerLengthOrg = 0.1  # real size of the marker in metres, this value does not change in algorithm
markerLength = markerLengthOrg  # real size of the marker in metres, this value changes in algorithm
board_length = 0.125 # the length of the black square in the base board
