...
config = ModelConfig.from_yaml_file('app.yaml')

start_frame = config.capturing.frames.start
...
saveResults = config.capturing.save_results
#True if you want to save images after detection on the disk, False otherwise
saveImages = config.capturing.save_images
...
drawPoints = draw_settings.points
