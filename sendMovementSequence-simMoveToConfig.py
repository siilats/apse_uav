...
timeStep = 0
sim.moveToConfig(-1,currentConf,None,None,maxVel,maxAccel,maxJerk,targetConfig,None,movCallback,jointHandles,timeStep=timeStep)
...
sim.moveToConfig(-1,currentConf,None,None,maxVel,maxAccel,maxJerk,targetConfig,targetVel,movCallback,jointHandles,timeStep=timeStep)
